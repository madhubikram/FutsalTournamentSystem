<template>
  <div 
    :class="[
      'bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white fixed h-full flex flex-col shadow-2xl transition-all duration-500 z-10',
...
const toggleSidebar = () => {
  ...
  // Dispatch custom event for PageLayout
