<template>
  <!-- Desktop Sidebar -->
  <div
    class="hidden md:flex bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white fixed h-full flex-col shadow-2xl transition-all duration-500 z-10"
    :class="sidebarWidth"
  >
    ...
    <div class="relative p-4 text-right">
      <button
        @click="toggleSidebar"
        class="group relative bg-gray-800/50 p-2 rounded-xl backdrop-blur-md border border-gray-700/50 hover:bg-emerald-500/10 hover:border-emerald-500/50 transition-all duration-300"
      >
    ...
    <div class="relative text-center mb-8 px-4">
      <div class="relative">
        <h1 class="text-2xl font-bold tracking-wide">
          ...
          <span class="text-emerald-400 text-xl inline-block transition-all duration-300 translate-y-0">
            ⚽
          </span>
        </h1>
    ...
    <div class="flex-grow px-3 relative">
      <nav class="space-y-2">
        ...
        >
          <div v-if="route.path === link.to" class="absolute inset-0 bg-emerald-500/20 blur-2xl"></div>
          <div class="relative">
            <component
              :is="link.icon"
    ...
    <div class="relative mt-auto">
      ...
      <div class="p-3">
        <button
          @click="handleLogout"
          class="w-full group flex items-center justify-center p-3 rounded-xl relative overflow-hidden transition-all duration-300"
        >
    ...
    <nav class="flex justify-around items-center h-16">
      ...
      >
        <component
          :is="link.icon"
          class="w-6 h-6 mb-1"
          :class="route.path === link.to ? 'drop-shadow-glow scale-110' : ''"
        />
...
// Computed property for the sidebar width based on collapse state
